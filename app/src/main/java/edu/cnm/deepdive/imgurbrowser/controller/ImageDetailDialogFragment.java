...
public class ImageDetailDialogFragment extends DialogFragment {
  ...
  public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_image_detail_dialogue, null, false);
    ...
    imageHeight.setText((image.getHeight() != null) ? "Height:" + image.getHeight() : "Height N/A");
    imageViews.setText((image.getViews() != null) ? "Views:" + image.getViews() : "Views N/A");
    imageBandwidth.setText((image.getBadnwidth() != null) ? "Bandwidth:" + image.getBadnwidth() : "Bandwidth N/A");
